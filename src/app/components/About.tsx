    ...
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <div className="w-20 h-1 bg-azure dark:bg-gold mx-auto"></div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {highlights.map((item, index) => (
              ...
              >
                <div className="w-12 h-12 bg-sunbus/15 dark:bg-[#fdc500]/15 text-azure dark:text-gold rounded-lg flex items-center justify-center mb-4">
                  {item.icon}
                </div>
